 ...
 * Counter 1 is a function expression stored in a variable, Counter 2 is a function declaration.

 * 2. Which of the two uses a closure? How can you tell?
 * Counter 1 uses a closure, because the inner function 'closes' over the variable count

 * 3. In what scenario would the counter1 code be preferable? In what scenario would counter2 be better? 
 * Counter 1 would be preferable if you wanted the variables to be private, Counter 2 would be better if other functions needed access to the variable count. 
*/
